...
const sendVerificationToken = async (
  ...
  const html = `
     <p>Dear ${fullName},</p>
     <p>Thank you for registering with <strong>Eye Care</strong>. To complete your registration, please verify your email address by using the verification token below:</p>
     ...
     <p>Thank you,<br>
     The <strong>Eye Care</strong> Team</p>
     <hr>
     ...
     <hr>
     <p>Eye Care | 24 A. Mabini Street, Pasig, 1600 Metro Manila`;
...
const sendPasswordResetToken = async (
  ...
  const html = `<p>Dear ${fullName},</p>
    <p>We received a request to reset your password for your <strong>Eye Care</strong> account. If you did not request a password reset, please ignore this email.</p>
...
const sendCheckoutOTP = async (recipientEmail, fullName, OTP) => {
  ...
  const html = `<p>Dear ${fullName},</p>
    <p>We received a request to checkout orders for your <strong>Eye Care</strong> account. If you did not request to checkout orders, please ignore this email.</p>
...
const sendGoogleAccountPassword = async (
  ...
  const html = `
     <p>Dear ${fullName},</p>
     <p>Thank you for registering with <strong>Eye Care</strong>. Your account password is indicated below:</p>
